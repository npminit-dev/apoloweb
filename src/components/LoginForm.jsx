...
const LoginForm = ({ mode, handleSubmit, user, setUser, validCredentials, handleSetMode, userExists }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='w-[300px] px-4 py-8 dark:bg-sec bg-main-light/70 rounded-md flex flex-col items-center fadeinright dark:border-txt border-[1px] border-txt-light/50'>
      ...
      <Button buttonProps={{ type: 'submit', disabled: shouldBeDisabled() }} classes={'hover:bg-sec-light mt-2'}>{mode}</Button>
      <LoginFormSwitcher 
